...
Date       : 2/6/2019.
Description: Implementation of pipeline witout forwarding logic.  
"""
...
while halt == 0:
	...
	# print("IF: Instruction: ", hex(i_s.instr))
	# print(Reg)
	# print()
	...
	if d_s.instr != 0:
		...
		if d_s.R_s in [e_s.R_d, m_s.R_d] and d_s.R_s != 0:
			stall = 1
		elif d_s.R_s in [e_s.R_t, m_s.R_t] and d_s.R_s != 0:
			stall = 1
		elif d_s.R_t in [e_s.R_d, m_s.R_d] and d_s.R_t != 0:
			if d_s.opcode in opcode_r_dict.keys():
				# print("yes")
				stall = 1
			if d_s.opcode == 15:
				stall = 1
		elif d_s.R_t in [e_s.R_t, m_s.R_t] and d_s.R_t != 0:
			if d_s.opcode in opcode_r_dict.keys():
				# print("yes")
				stall = 1
			if d_s.opcode == 15:
...
print("clock: ", clock, "Stall_count: ", Stall_count, " Stall_cycles: ", Stall_cycles, "Stall_penality: ", float(1.0*Stall_cycles/Stall_count), "Branches taken: ", branch)
in_f.close()
